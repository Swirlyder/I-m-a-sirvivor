...
let gameTypes = {
	...
	battleroyale: [ 'Battle Royale', 'https://survivor-ps.weebly.com/battle-royale.html', '"It\'s like Fortnite but worse" ~ Survivor Gaming Critics', 1 ],
	...
	emp: 'empire',
	evolve: [ 'Evolve', 'https://docs.google.com/document/d/1e5mlK44p2qlHwZwlRw769qMhB2-iYpVsMbhiFlw_cPw/edit?usp=sharing', 1, 1 ],
	evo: 'evolve',
	fishing: [ 'Fishing', 'https://docs.google.com/document/d/1V4pS7M2sa5ZAoKAk5Oi6D5src-VFe4M2mMtIcliS7Y4/edit?usp=sharing', 1, 1 ],
	fish: 'fishing',
	ghostsbusters: [ 'Ghosts (Busters)', 'https://docs.google.com/document/d/1hAGFIyANpWBuyawcWl7lO7qt9fyI8ZRm0vWjM2v7GjU/edit', 1, 1 ],
	gb: 'ghostsbusters',
	ghosts: 'ghostsbusters',
	gottacatchemall: [ 'Gotta Catch Em All', 'https://docs.google.com/document/d/1qeAESeMRZE_9m98wLVlgrv_tCfxWNLlJ_eLHyG1tUFA/edit', 1, 1 ],
	gcea: 'gottacatchemall',
	hiddenpowersurvivor: [ 'Hidden Power Survivor', 'https://docs.google.com/document/d/1RpV7ILFcpmxwWGMU8MUR1s9iUGfYFykimG69NWTpoUQ/edit?usp=sharing', 1, 1 ],
	...
	jenga: [ 'Jenga', 'https://docs.google.com/document/d/1D1XX8KVKH0Za0xWjN7oasLdRiBqTPYmDTRjuyuNwvJw/edit', 'The classic game! But it\'s... Survivor...?', 1, 1 ],
	minefield: [ 'Minefield', 'https://docs.google.com/document/d/12F9JX4_NPg-VOsXS5AjOqTgWqx9JQ8Mcs7U16UL47pQ/edit?usp=sharing', 'Word of advice: Don\'t die', 1, 1 ],
	rollboost: [ 'Roll Boost', 'https://docs.google.com/document/d/1zUwbZYFvCugCDshmomE5bLqFVH7PF1to2gtpbFauLqo/edit?usp=sharing', 'Spend your points wisely! \\\\or just roll 100 every time and win anyway\\\\', 1, 1 ],
	rb: 'rollboost',
	santasautomatedworkshop: [ 'Santa\'s Automated Workshop (SAW)', 'https://docs.google.com/document/d/1e-nO4aLdlSP5lCq-FfReTlkzDIOjrKhiaN5-rTtr3dI/edit', 'Deliver presents like a true good person', 1, 1 ],
	saw: 'santasautomatedworkshop',
	statusconditionsurvivor: [ 'Status Condition Survivor', 'https://docs.google.com/document/d/1LeSBo7SSkRJG8PqUKk8MflKSdTuF2nl-rkFstjQJ9iQ/edit?usp=sharing', 'BURN!! HAHAHA okay sorry that wasn\'t funny', 1, 1 ],
	scs: 'statusconditonsurvivor',
	swords: [ 'Swords', 'https://docs.google.com/document/d/17p0KJEQhr8h13MYfp8bQoNcpQDe7Gh9i6MVvKzU7ut8/edit', 'Get the strongest sword to beat your foes!', 1, 1 ],
	tribalcouncil: [ 'Tribal Council', 'https://docs.google.com/document/d/1TyAGHO5YRZ5hEfS9cLwEeZpebztXK1upnqqqBLAUxVw/edit', 'Somehow this theme name reminded me of Spore, anyone remember the game Spore?', 1, 1 ],
	tc: 'tribalcouncil',
	vivorsfeast: [ 'Vivor\'s Feast', 'https://docs.google.com/document/d/1CRKg7wF8ZqmLtzOSXl47_1U_i1Ka0n42D4P_EKWnHJw/edit?ts=5933515a', 'Sacrifice people to the Vivor overlord', 1, 1 ],
	vf: 'vivorsfeast',
	feast: 'vivorsfeast',
	vwheelanddeal: [ 'V-Wheel and Deal', 'https://docs.google.com/document/d/15zQMGT--GrckvWlH5514fpmotas-C86nRmOAavPFANI/edit', 'It\'s like a lottery but worse', 1, 1 ],
	vwd: 'vwheelanddeal',
	wnd: 'vwheelanddeal',
	weardown: [ 'Wear Down', 'https://docs.google.com/document/d/1f_RGAU9ezc1zryJRtfB3ckGY98jIqnuaVLg3_LfrGJc/edit', 'The game where we all get frustrated over losing all of our health in 2 rounds', 1, 1 ],
	welcometoourchat: [ 'Welcome to Our Chat.jpg Survivor', 'https://docs.google.com/document/d/1bY8P-wvzPyR0RzrzAQtkjWqT5tYAHGr8YXunVDN4uFE/edit', 'When are we adding Gumwaa to this theme?', 1, 1 ],
