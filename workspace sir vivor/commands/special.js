...
module.exports = {
	...
	para: function (arg, user, room) {
		let text1 = 'I\'m Paradise and this is my Anime club. I work here with my friends and fellow weebs: Spieky, Bon Dance, Don’t Lose, Aknolan, PenQuin, Swirlyder, Aknolan, Moo, Snap, Henka, OM, Zeonth, Zyx14, Shadecession, deetah, Hurl, zyg, Guishark, Mitsuki, Tushavi, cleo, ptoad, Rainshaft, pants, wob, Audiino, Ceteris, Gimmick, Harambeween, abd1710, TheBluestEye, BugBuzzing, EasyOnTheHills, Felucia, micromorphic, Megagr, Penguin D, ClaudioINK58, lfolfo, BreadLoeuf, beautifications, 2guhde4u, Gary The Savage, marillvibes, Opple, Le\'Depression, SaltiestCactus43, Sificon, crabachillable, yunino, NeonAlphaa, a helpful rayquaza, GuyGuard, Andrew Nick, Gian, Morgan Tactician, Chapter Seven, and in 31 years, I\'ve learned one thing. You never know WHAT anime is going to be good.';
