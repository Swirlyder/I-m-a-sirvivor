...
module.exports = {
	...
	para: function (arg, user, room) {
		...
		let text4 = 'beautifications, 2guhde4u, Gary The Savage, marillvibes, Opple, Le\'Depression, SaltiestCactus43, Sificon, crabachillable, yunino, NeonAlphaa,';
		let text5 = 'a helpful rayquaza and in 31 years, I\'ve learned one thing. You never know WHAT anime is going to be good.';
